...
const Header = () => {
  ...
  return (
    <div className="w-full text-white py-0 flex justify-between items-center border-b-[1px] border-b-blue-600 relative z-50">
      <div>
        <img src={logo} alt="KODPROG" className="h-24 md:h-28 w-auto" />
      </div>
